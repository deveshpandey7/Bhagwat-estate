...
export default function Search() {
    ...
    const onShowMoreClick = async () => {
        ...
        // add new array of listings to previous one using spread operator
  ...
  return (
    <div className='flex flex-col md:flex-row'>
      <div className="p-7 border-b-2 md:border-r-2 md:min-h-screen">
        <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
            <div className="flex items-center gap-2">
                ...
                <input value={sidebardata.searchTerm} onChange={handleChange} type="text" id='searchTerm' name='searchTerm' placeholder='Search...' className='border rounded-lg p-3 w-full' />
            </div>
      ...
      <div className="flex-1">
       <h1 className='text-3xl font-semibold border-b-3 p-3 text-slate-700 mt-5'> Listing Results: </h1>
